        ...
        <ul class="nav navbar-right float-right list-inline">
            ...
            <li class="dropdown">
                <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true">
                    <img src="{{ url('/') }}/images/proceso.svg" alt="user-img" class="rounded-circle">
                    
                </a>
                <ul class="dropdown-menu-right dropdown-menu">
                    <li><a href="javascript:void(0)" class="dropdown-item"> {{ Auth::user()->Persona }}</a></li>
                    {{-- <li><a href="javascript:void(0)" class="dropdown-item"> {{ trans('labels.modules.Perfil')}}</a></li> --}}
